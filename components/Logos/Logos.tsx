...
export const Logos = [
    ...
    { name: "figma", url: <Figma className="size-12 " /> },
    ...
    { name: "tailwindCSS", url: <Tailwind className="size-10 2xl:size-12" /> },
    { name: "prisma ORM", url: "https://img.icons8.com/?size=100&id=aqb9SdV9P8oC&format=png&color=000000" },
    { name: "websocket", url: <Websocket className="size-8 2xl:size-12 " /> },
    { name: "turborepo", url: <Turborepo className="size-8 2xl:size-12 " /> },
    ...
    { name: "ganache", url: <Ganache className="size-8 2xl:size-12 " /> },
    { name: "truffle", url: <Truffle className="size-8 2xl:size-12 " /> },
    { name: "hardhat", url: <Hardhat className="size-8 2xl:size-12 " /> },
